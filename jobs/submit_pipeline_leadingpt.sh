...
#SBATCH --output=logs/slurm-leading_jetpt_label0-%j.out
#SBATCH --error=logs/slurm-leading_jetpt_label0-%j.err
...
echo "Command: python scripts/run_pipelines.py"
echo "Time started: $(date)"

# Run with output capture and timestamping
python scripts/run_pipelines.py 2>&1 | while IFS= read -r line; do
