...
def run_foundation_pipeline(
    ...
    if process_type not in valid_processes:
        raise ValueError(f"Invalid process type: {process_type}. Must be one of {valid_processes}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--delete-catalogs", action="store_true",
                        help="Delete catalogs after processing")
    parser.add_argument("--foundation-model", type=str, default=None,
